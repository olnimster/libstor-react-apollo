...
import {BookType, DataBookType} from "../types/types";
...
const BiggestCard: React.FC<DataBookType> = ({book}):JSX.Element => {
    ...
    if (getBooksFormBookshelf) {
        isBookInBookshelf = (!!(getBooksFormBookshelf.find((el: BookType) => el.id === book.id)));
    }
